...
public class GreetingsController {
	...
	// NOVO END POINT NO LINK: http://localhost:8000/mostrarnome/otavio (RETORNAR UM
	// OLA)
	...
	// NOVO END POINT NO LINK:
	// http://localhost:8000/mostrarnome/otavio/olamundo/otavio (RETORNA MENSAGEM)
	...
	// MÉTODO DE BUSCAR NO BANCO E RETORNAR UM JSON NO
	// http://localhost:8000/listatodos (RETORNA JSON)
	...
	public ResponseEntity<Usuario> salvar(@RequestBody Usuario usuario) { // recebe os dados para salvar
		// isso aqui acima recebe a classe usuario e dá o propio nome usuario (ELE
		// RECEBE OS DADOS PASSADOS E INJETA)
	...
	public ResponseEntity<?> atualizar(@RequestBody Usuario usuario) {// RETORNAR UM USUARIO
		...
		if (usuario.getId() == 0) {
			return new ResponseEntity<String>("Id não informado para atualização. " + "Informe o Id para continuar...",
					HttpStatus.OK);
		}
